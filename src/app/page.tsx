...
import { Calendar, Users, Clock, Settings, LogOut, BarChart3 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-sm xs:text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold text-gray-900 whitespace-nowrap">회의실 예약 시스템</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={navigateToNewReservation}>
          ...
          <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={navigateToDashboard}>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
